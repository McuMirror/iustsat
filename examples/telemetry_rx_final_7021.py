...
class telemetry_rx_final_7021(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, MTU=1500):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/iust/Documents/zafar_prj/REC4.bin', True)
...
def main(top_block_cls=telemetry_rx_final_7021, options=None):
    if options is None:
