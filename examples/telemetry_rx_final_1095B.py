...
# Title: Telemetry Rx Final 1095B
...
class telemetry_rx_final_1095B(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, MTU=1500):
        ...
        self.iustsat_zafar_telemetry_deinterleave_0 = iustsat.zafar_telemetry_deinterleave("pkt_len")
        self.iustsat_tag_counter_0 = iustsat.tag_counter('pkt_len')
        self.iustsat_synch_detect_tag_1_0 = iustsat.synch_detect_tag(60,'pkt_len',1279*2*8)
        self.iustsat_synch_detect_tag_1 = iustsat.synch_detect_tag(60,'pkt_len',1279*2*8)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/iust/Documents/zafar_prj/REC5_1095B.bin', True)
        ...
        self.msg_connect((self.iustsat_pack_rsblock_0, 'out'), (self.blocks_pdu_to_tagged_stream_0, 'pdus'))
        self.msg_connect((self.iustsat_pack_rsblock_0, 'out'), (self.iustsat_rs_to_decrypt_0_0, 'in'))
        ...
        self.msg_connect((self.iustsat_zafar_telemetry_deinterleave_0, 'out'), (self.satellites_decode_rs_general_0, 'in'))
        self.msg_connect((self.iustsat_zafar_telemetry_derand_0, 'out'), (self.iustsat_zafar_telemetry_deinterleave_0, 'in'))
        self.msg_connect((self.iustsat_zafar_telemetry_frame_extractor_1, 'out'), (self.fec_async_decoder_0, 'in'))
        self.msg_connect((self.satellites_decode_rs_general_0, 'out'), (self.iustsat_pack_rsblock_0, 'in'))
...
def main(top_block_cls=telemetry_rx_final_1095B, options=None):
    if options is None:
